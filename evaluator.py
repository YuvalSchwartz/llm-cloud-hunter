...
if __name__ == "__main__":
    ...
    # file_prefixes.append('ransomware_in_the_cloud')
    # file_prefixes.append('shinyhunters-ransomware-extortion')
    # file_prefixes.append('sugarcrm_cloud_incident_black_hat')
    # file_prefixes.append('tales-from-the-cloud-trenches-aws-activity-to-phishing')
    # file_prefixes.append('tales-from-the-cloud-trenches-ecs-crypto-mining')
    # file_prefixes.append('tales-from-the-cloud-trenches-raiding-for-vaults-buckets-secrets')
    # file_prefixes.append('the-curious-case-of-dangerdev-protonmail-me')
